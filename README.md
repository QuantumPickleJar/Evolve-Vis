...
## Build Commands
Run `npm install` to install `esbuild` and other dependencies before running any build scripts.
Once your environment is ready the game can be built, deployed to GitHub Pages or launched using
```
